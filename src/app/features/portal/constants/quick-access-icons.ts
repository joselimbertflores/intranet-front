...
export const QUICK_ACCESS_ICON_REGISTRY = {
...
type QuickAccessIconName = keyof typeof QUICK_ACCESS_ICON_REGISTRY;

const QUICK_ACCESS_ICON_NAMES: Readonly<
  Record<QuickAccessIconKey, QuickAccessIconName>
> = {
...
export function quickAccessIconName(
  iconKey: QuickAccessIconKey,
): QuickAccessIconName {
  return QUICK_ACCESS_ICON_NAMES[iconKey];
}
